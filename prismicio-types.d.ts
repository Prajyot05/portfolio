...
export interface ExperienceSliceDefaultPrimaryInfoItem {
  ...
  /**
   * Logo field in *Experience → Default → Primary → Info*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.info[].logo
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Item in *TechList → Default → Primary → Tech Info*
 */
export interface TechListSliceDefaultPrimaryTechInfoItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech Info*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_info[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Tech Info*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_info[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech Info field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_info[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  tech_info: prismic.GroupField<
    Simplify<TechListSliceDefaultPrimaryTechInfoItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TechListSlice,
      TechListSliceDefaultPrimaryTechInfoItem,
